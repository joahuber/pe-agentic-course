...
Bug 2: line 35 — `version = APP_VERSION  # Fixed: was app_version (NameError)`
...
def get_version() -> str:
    ...
    version = APP_VERSION  # Fixed: was app_version (NameError)
    return version
...
if __name__ == "__main__":
    ...
    # Bug 2 fires here — get_version calls `version = APP_VERSION  # Fixed: was app_version (NameError)`
